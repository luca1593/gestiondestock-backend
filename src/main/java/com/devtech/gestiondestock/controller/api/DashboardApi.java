...
public interface DashboardApi {
    @PostMapping(value = APP_ROOT + "/dashbaord/story", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    DashboardResponse getDasboardData(@RequestBody DashboardRequest request);
}
