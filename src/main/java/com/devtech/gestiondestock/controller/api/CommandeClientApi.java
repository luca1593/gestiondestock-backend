...
public interface CommandeClientApi {
    @PostMapping(value = APP_ROOT + "/commande-client/create", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "Enregistrement d'une commande client",
            notes = "Cette methode permet d'enregidtre ou de modifier une commande client",
    ...
    @PatchMapping(value = APP_ROOT + "/commande-client/update/etat/{idCommande}/{etatCommande}", produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiResponses(value = {
    ...
    @PatchMapping(value = APP_ROOT + "/commande-client/update/quantite/{idCommande}/{idLigneCommande}/{quantite}", produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiResponses(value = {
    ...
    @PatchMapping(value = APP_ROOT + "/commande-client/update/client/{idCommande}/{idClient}", produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiResponses(value = {
    ...
    @PatchMapping(value = APP_ROOT + "/commande-client/update/article/{idCommande}/{idLigneCommande}/{newIdArticle}", produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiResponses(value = {
    ...
    @DeleteMapping(value = APP_ROOT + "/commande-client/delete/article/{idCommande}/{idLigneCommande}", produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiResponses(value = {
    ...
    @GetMapping(value = APP_ROOT + "/commande-client/list/linge-commande/{idCommande}", produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiResponses(value = {
    ...
    ResponseEntity<List<LigneCommandeClientDto>> findAllByCommandeClient(@PathVariable("idCommande") Integer idCommande);

    @GetMapping(value = APP_ROOT + "/commande-client/{idCommandeClient}", produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "Rechercher une commande client",
            notes = "Cette methode permet de rechercher une commande client par son ID",
            response = CommandeClientDto.class
    )
    @ApiResponses(value = {
    ...
    @GetMapping(value = APP_ROOT + "/commande-client/code/{codeCommandeClient}", produces = MediaType.APPLICATION_JSON_VALUE)
    @ApiOperation(value = "Rechercher une commande client",
            notes = "Cette methode permet de rechercher une commande client par son code",
            response = CommandeClientDto.class
    )
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "L'objet commande client a ete trouver dans la BDD"),
    ...
    @GetMapping(value= APP_ROOT + "/commande-client/date/{dateCommandeClient}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    ResponseEntity<List<CommandeClientDto>> findByDateCommande(@PathVariable("dateCommandeClient") Instant dateCommande);
