...
public interface CommandeClientApi {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "L'objet commande client creer ou modifier", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CommandeClientDto.class))),
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "L'objet commande client a ete trouver dans la BDD", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, schema = @Schema(implementation = CommandeClientDto.class))),
        ...
        @Operation(summary = "Rechercher liste des commandes client par date", description = "Cette methode permet de rechercher liste des commandes client par date")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Aucune commande client n'a ete trouver dans la BDD", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, array = @ArraySchema(schema = @Schema(implementation = CommandeClientDto.class)))),
        ...
        @Operation(summary = "Renvoie la liste des commandes client", description = "Cette methode permet de rechercher toutes les commandes client dans la BDD")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "La liste des commandes client / liste vide", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, array = @ArraySchema(schema = @Schema(implementation = CommandeClientDto.class))))
        })
        ResponseEntity<List<CommandeClientDto>> findAll();

        @PostMapping(value = APP_ROOT
                        + "/commande-client", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
        @Operation(summary = "Renvoie la liste des commandes client selon le client", description = "Cette methode permet de rechercher toutes les commandes client selon le client")
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "La liste des commandes client selon le client / liste vide", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, array = @ArraySchema(schema = @Schema(implementation = CommandeClientDto.class))))
        })
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "La liste des commandes client / liste vide", content = @Content(mediaType = MediaType.APPLICATION_JSON_VALUE, array = @ArraySchema(schema = @Schema(implementation = LigneCommandeClientDto.class))))
        })
        ResponseEntity<List<LigneCommandeClientDto>> findAllLigneCommandeClient(
                        @PathVariable("idCommande") Integer icCommade);
}
